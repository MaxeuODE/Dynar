...
public class Util {
    ...
    public static <U> void assessTimeUsage(Runnable task, @Nullable U customMsg) {
        long start = System.nanoTime();
        task.run();
        long finish = System.nanoTime();
        double durationInMillis = (double) (finish - start) / 1_000_000.0;
        String msg = customMsg != null ? customMsg.toString() : "";
        Util.sendLogInfo(msg + "Time Usage: " + durationInMillis + "ms");
    }
}
